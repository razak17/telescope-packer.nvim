...
for _, plugin in ipairs(results) do
    plugin_name_width = #plugin.name > plugin_name_width and #plugin.name or
                            plugin_name_width
end
...
local plugins = function(opts)
    ...
    local displayer = entry_display.create {
        separator = "",
        items = {{width = plugin_name_width + 1}, {remaining = true}}
    }
...
return telescope.register_extension {exports = {plugins = plugins}}
